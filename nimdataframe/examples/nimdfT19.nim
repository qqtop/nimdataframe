...
showdf(ndf9,                        # returns 
              ...
              leftalignflag = true,
              frtexttop = ndf9.frtexttop,
              xpos = 3)
showDataframeInfo(ndf9,10)


var ndf10 = sortDf(ndf9,testsortcolumn,"asc")  
ndf10.frtexttop = @["Sorted BundesLiga Dataframe"]
showdf(ndf10,                        # returns 
              ...
              leftalignflag = true,
              frtexttop = ndf10.frtexttop,
              xpos = 3)           
showDataframeInfo(ndf10,10)
